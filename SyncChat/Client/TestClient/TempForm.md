...
<TextBox x:Name="textBoxPort" HorizontalAlignment="Left" Height="23" Margin="229,50,0,0" TextWrapping="Wrap" Text="54321" VerticalAlignment="Top" Width="77" Grid.ColumnSpan="2"/>
...
<Button Content="접속" HorizontalAlignment="Left" Height="26" Margin="130,45,0,0" VerticalAlignment="Top" Width="37" Click="Button_Click" Grid.Column="1"/>
...
<TextBox x:Name="textBoxPW" HorizontalAlignment="Left" Height="25" Margin="219,102,0,0" TextWrapping="Wrap" Text="32452" VerticalAlignment="Top" Width="87" Grid.ColumnSpan="2"/>
<Button Content="로그인" HorizontalAlignment="Left" Height="26" Margin="19,100,0,0" VerticalAlignment="Top" Width="38" Click="Button_Click_1" Grid.Column="1"/>        
<Button Content="로그아웃" HorizontalAlignment="Left" Height="26" Margin="64,100,0,0" VerticalAlignment="Top" Width="50" Click="Button_Click_7" Grid.Column="1"/>
<Button Content="회원가입" HorizontalAlignment="Left" Height="26" Margin="124,100,0,0" VerticalAlignment="Top" Width="64" Click="Button_Click_7" Grid.Column="1"/>
<GroupBox Header="GroupBox" HorizontalAlignment="Left" Height="276" Margin="10,171,0,0" VerticalAlignment="Top" Width="484" Grid.ColumnSpan="2">
        ...
        <TextBox x:Name="textBoxSendChat" KeyDown="TextBox_KeyDown" HorizontalAlignment="Left" Height="22" Margin="153,416,0,0" TextWrapping="Wrap" Text="Hi~~" VerticalAlignment="Top" Width="271" Grid.ColumnSpan="2"/>
        <Button Content="chat" HorizontalAlignment="Left" Height="21" Margin="136,415,0,0" VerticalAlignment="Top" Width="42" Click="Button_Click_5" Grid.Column="1"/>
        ...
        <TextBox x:Name="textBoxEcho" HorizontalAlignment="Left" Height="25" Margin="13,142,0,0" TextWrapping="Wrap" Text="test1" VerticalAlignment="Top" Width="353" Grid.ColumnSpan="2"/>
        <Button Content="닉네임으로사용" HorizontalAlignment="Left" Height="26" Margin="78,141,0,0" VerticalAlignment="Top" Width="90" Click="Button_Click_6" RenderTransformOrigin="0.836,2.049" Grid.Column="1"/>
        <!-- <Button Content="Echo" HorizontalAlignment="Left" Height="26" Margin="78,141,0,0" VerticalAlignment="Top" Width="38" Click="Button_Click_9" RenderTransformOrigin="0.836,2.049" Grid.Column="1"/> -->
        <Button Content="모든 게임방 게임 시작" HorizontalAlignment="Left" Height="27" Margin="13,452,0,0" VerticalAlignment="Top" Width="124" Click="Button_Click_7"/>
        <Button Content="접속 끊기" HorizontalAlignment="Left" Height="26" Margin="120,452,0,0" VerticalAlignment="Top" Width="64" Click="Button_Click_2" Grid.Column="1"/>
        <Button Content="모든 게임방 게임 끝" HorizontalAlignment="Left" Height="27" Margin="147,452,0,0" VerticalAlignment="Top" Width="129" Click="Button_Click_8"/>
        <!-- <Button Content="채팅 지우기" HorizontalAlignment="Left" Height="27" Margin="300,452,0,0" VerticalAlignment="Top" Width="129" Click="Button_Click_8"/> -->
